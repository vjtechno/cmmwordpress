...
<div class="wrap">    
    <div class="oxilab-admin-wrapper">
        <div class="oxi-addons-promote-header">
            ...
            <div class="oxilab-admin-wrapper">
                <div class="oxilab-admin-coupon" style="margin:  0 auto; max-width: 800px;padding: 10px 20px; text-align: center">
                    <?php
                    $now = (strtotime("now"));
                    ...
                    if ($status == 'valid') {
                        ...
                        echo 'Exclusive offer: Responsive Tabs and Accordions are completely free with Shortcode Addons';
                    }
                    ?>
                </div>
            </div>
