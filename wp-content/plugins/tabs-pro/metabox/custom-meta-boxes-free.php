 ...
 * @return null
 */
function cmb_init_not_tabultimates_acc_fre() {
...
add_action( 'init', 'cmb_init_not_tabultimates_acc_fre' );
 ...
 * @return array
 */
function _cmb_available_fields_not_tabultimates_acc_fre() {
 ...
 */
function _cmb_field_class_for_type_not_tabultimates_acc_fre( $type ) {

	$map = _cmb_available_fields_not_tabultimates_acc_fre();
 ...
 * @return string $query
 */
function cmb_fix_meta_query_order_not_tabultimates_acc_fre($query) {
...
if ( version_compare( get_bloginfo( 'version' ), '3.8', '<' ) )
	add_filter( 'query', 'cmb_fix_meta_query_order_not_tabultimates_acc_fre', 1 ); 