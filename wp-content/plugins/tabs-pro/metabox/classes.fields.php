...
class CMB_Group_Field extends CMB_Field {
	...
	function __construct() {
		...
		if ( ! empty( $this->args['fields'] ) ) {
			foreach ( $this->args['fields'] as $f ) {
				...
				$class = _cmb_field_class_for_type_not_tabultimates_acc_fre( $f['type'] );
				$f['show_label'] = true;
	...
	public function html() {
		...
		<?php if ( $this->args['repeatable'] ) : ?>
			<button class="cmb-delete-field button button-primary" title="Remove field"><span class="cmb-delete-field-icon">&times;</span> Delete </button>
		<?php endif; ?>
